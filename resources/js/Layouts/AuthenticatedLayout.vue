  ...
  <div>
    <div class="min-h-screen bg-gray-100">
          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <NavLink :href="route('admin.product-category.index')" :active="route().current('admin.product-category.index') ||
                  route().current('admin.product-category.create') ||
                  route().current('admin.product-category.edit')
                  ">
                  Product Category
                </NavLink>
      ...
      <main>
        <v-container>
          <Card
            v-show="($page.props?.errors && $page.props?.errors?.alertMessage) || ($page.props?.success && $page.props?.success?.alertMessage)">
            <template #content>
              <Errors></Errors>
              <Success></Success>
            </template>
