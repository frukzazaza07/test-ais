...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Product::create([
            ...
            'p_name_en' => 'xiaomi TV',
            'p_serial_number' => generateSerialNumber(ProductCategory::TV),
            'p_price' => 40000,
            'p_pc_id' => 1,
            'p_user_id' => 1,
        ]);
        ...
        Product::create([
            ...
            'p_serial_number' => generateSerialNumber(ProductCategory::FRIDEGE),
            'p_price' => 40000,
            'p_pc_id' => 2,
            'p_user_id' => 1,
        ]);
        ...
        Product::create([
            ...
            'p_serial_number' => generateSerialNumber(ProductCategory::IRON),
            'p_price' => 40000,
            'p_pc_id' => 3,
            'p_user_id' => 1,
        ]);
